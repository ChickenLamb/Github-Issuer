...
export default function BasicModal({ updateForm, handleClose, token,LoadIssue }: Props) {
    async function getID_and_update(submitData: FormData) {
        ...
        await axios.request(config)
            .then((response: any) => {
                ...
                {
                    toast("Update Successfully",{type:"success",autoClose:1500});
            ...
            .catch((error: any) => {
                console.log(error);
                toast.update("Something went wrong",{ type: "error", isLoading: false, autoClose:2500});
            });
        }
        else{
